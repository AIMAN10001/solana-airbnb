...
function ListingItem({
  ...
  return (
    <div className="flex flex-col bg-[#072A2A] custom-shadow p-2 rounded-lg space-y-3 cursor-pointer">
      ...
      <div>
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-1">
            <StarIcon className="h-3 w-3 text-[#4dc0c2]" />
            <p className="text-sm text-gray-400">{4.8}</p>
          </div>
        </div>

        <p className="text-sm font-light text-gray-400">{788} kilometers</p>
