...
export default function ReserveListingModal({
  reserveListing,
  currentEditListing,
  reserveListingModalOpen,
                ...
                <div className="mt-2">
                  ...
                  <div className="mt-4 flex justify-end">
                    <button
                      onClick={onConfirm}
                      type="button"
                      className="border border-[#116466] hover:bg-[#116466] transition duration-300 hover:text-gray-200 rounded-lg px-4 py-2 text-sm font-medium"
                    >
                      Confirm
                    </button>
                  </div>
